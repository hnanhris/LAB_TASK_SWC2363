...
if($_SERVER ['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['Specialization'])) {
        $error[] = 'You forgot to enter yhe Specialization.';
    } else {
...
echo '<p class="error">The no ic has already been registered</p>';
        ...
        echo '<p class ="error"> The following errror (s) occured: <br/>';
...
echo '<form action ="edit_doktor.php" method="post">
    ...
    <input id = "FirtsName" type ="text" name ="FirstName" size="30" maxlength="30" value="'.$row[0].'"></p>
