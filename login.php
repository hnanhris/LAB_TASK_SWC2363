...
$q = "SELECT ID, FirstName, Specialization, Password FROM Doktor WHERE (ID = '$un' AND Password = '$p')";
...
//run the query and assign it to the variable result
    ...
    if (@mysqli_num_rows ($result) == 1)  {
        //start the session, fetch the record and insert the three values in a array
        session_start();
